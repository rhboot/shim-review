...
Skip this, if you're using a different second-stage bootloader.
*******************************************************************************
[your text here]

*******************************************************************************
### Do you have fixes for all the following GRUB2 CVEs applied?
**Skip this, if you're using a different second-stage bootloader, otherwise make sure these are present and confirm with _yes_.**
...
Skip this, if you're using a different second-stage bootloader, otherwise do you have an entry in your GRUB2 binary similar to:  
...
Skip this, if this is your first application for having shim signed. Otherwise a simple _yes_ will do.
*******************************************************************************
[your text here]
...
Skip this if this is your first application for having shim signed or if you are changing to a new CA certificate.
